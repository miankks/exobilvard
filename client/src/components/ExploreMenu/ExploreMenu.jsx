    ...
    <div className="explore-menu" id="explore-menu">
      <div className="heading-section">
        ...
        <p className="explore-menu-text">
          Välkommen till EXO Bilvårdscenter – en modern och professionell
          bilverkstad där kvalitet, trygghet och personligt bemötande står i
          fokus.
        </p>
        ...
        <div className="text-point scroll-show">
          ...
          <p className="explore-menu-text">
            Boka tid redan idag och låt oss ta hand om din bil med högsta
