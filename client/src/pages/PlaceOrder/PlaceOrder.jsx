    ...
    <form onSubmit={placeOrder} className="place-order">
      <div className="place-order-left">
        ...
        <input
          ...
          onInvalid={(e) =>
            e.target.setCustomValidity("Fyll i ditt fullständiga namn")
          }
        ...
        <input
          ...
          onChange={onChangeHandler}
          onInvalid={(e) =>
            e.target.setCustomValidity("Fyll i ditt fullständig email")
          }
          onInput={(e) => e.target.setCustomValidity("")}
          value={data.email}
          type="email"
        ...
        <input
          ...
          onChange={onChangeHandler}
          onInvalid={(e) =>
            e.target.setCustomValidity("Fyll i ditt telefonnummer")
          }
          onInput={(e) => e.target.setCustomValidity("")}
          value={data.phone}
          type="text"
        ...
        <div className="regandmileage">
          <div className="input-group">
            ...
            <input
              ...
              onChange={onChangeHandler}
              onInvalid={(e) =>
                e.target.setCustomValidity("Fyll i ditt bil regnummer")
              }
              onInput={(e) => e.target.setCustomValidity("")}
        ...
        <Reactdatepicker
          sendDataToParent={handleDate("bookDate1")}
          selectDate={"Första tid"}
          selectime={"Första datum"}
        />
        <Reactdatepicker
          sendDataToParent={handleDate("bookDate2")}
          selectDate={"Andra tid"}
          selectime={"Andra datum"}
        />
        <Reactdatepicker
          sendDataToParent={handleDate("bookDate3")}
          selectDate={"Tredje tid"}
          selectime={"Tredje datum"}
        />
      </div>
        ...
        <div className="cart-total">
          ...
          <div className="placeorder-comment-section">
            <label htmlFor="userComment">
              Kommentar till Eobilvårdscenter (krävs inte)
            </label>
            <textarea
              name="userComment"
              rows="6"
